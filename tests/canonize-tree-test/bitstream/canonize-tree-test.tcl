...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:canonize_tree:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: canonize_tree_0, and set properties
  set canonize_tree_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:canonize_tree:1.0 canonize_tree_0 ]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /canonize_tree_0/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins canonize_tree_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins canonize_tree_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs canonize_tree_0/s_axi_AXILiteS/Reg] SEG_canonize_tree_0_Reg
